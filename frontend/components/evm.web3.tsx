...
export default class EthereumRpc {
  ...
  async createPromise(_promiseData: IPromiseData): Promise<any> {
    ...
    const receipt = await this.contract.methods.createPromise(
      _promiseData,
      '0x163b09b4fE21177c455D850BD815B6D583732432', // WorldID
      '0x4200000000000000000000000000000000000021', // EAS
      '0x5b4527d58b157935f1a908d09d295ba6ba890e9b7177a0ea3d4ba391b36e6c5f', // Schema
  ...
  async claimPromise(promiseAddress: string, root: string, nullifierHash: string, proof: string[]): Promise<any> {
    const accounts = await this.web3.eth.getAccounts();
    const promise = new this.web3.eth.Contract(contractPromiseABI, promiseAddress);
    const receipt = await promise.methods.claimPromise(root, nullifierHash, proof).send({
      from: accounts[0]
    });
